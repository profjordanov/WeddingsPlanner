...
namespace WeddingsPlanner.Api.Configuration
{
    public static class DependenciesConfiguration
    {
        ...
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                setup.SwaggerDoc("v1", new Info { Title = "WeddingsPlanner.Api", Version = "v1" });
                setup.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "WeddingsPlanner.Api.Documentation.xml"));
